...
public class DashedView: UIView {
    public struct Defaults {
        ...
        public static let dashcolor = UIColor.init(red: 233.0/255.0, green: 194.0/255.0, blue: 84.0/255.0, alpha: 1)
    }
    ...
    private func createSceneContainer() {
      sceneContainer = UIView(frame: CGRect(origin: CGPoint(), size: Defaults.size))
        sceneContainer.backgroundColor = .clear//Defaults.backgroundColor
    ...
    private func createD() {
        ...
        d.shapeLayer.strokeColor = Defaults.dashcolor.cgColor//UIColor(red: 0.004, green: 0.086, blue: 0.541, alpha: 1).cgColor
    ...
    private func createC() {
        ...
        c.shapeLayer.strokeColor = Defaults.dashcolor.cgColor // UIColor(red: 0.004, green: 0.086, blue: 0.541, alpha: 1).cgColor
    ...
    private func createB() {
        ...
        b.shapeLayer.strokeColor = Defaults.dashcolor.cgColor // UIColor(red: 0.004, green: 0.086, blue: 0.541, alpha: 1).cgColor
    ...
    private func createA() {
        ...
        a.shapeLayer.strokeColor = Defaults.dashcolor.cgColor //UIColor(red: 0.004, green: 0.086, blue: 0.541, alpha: 1).cgColor
